module JiraApiMock
  def stub_get_bugs_ok(payload, jira_project_key)
    ...
    stub_request(:get, "#{ENV['JIRA_ROOT_URL']}/jira/rest/api/2/search?jql=project=#{jira_project_key}%20AND%20issuetype=Bug&fields=#{ENV['JIRA_ENVIRONMENT_FIELD']},created")
      .to_return(
