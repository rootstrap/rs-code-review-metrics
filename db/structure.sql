...
--
-- Name: index_jira_issues_on_product_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_jira_issues_on_product_id ON public.jira_issues USING btree (product_id);
...
--
-- Name: jira_issues fk_rails_97fc208031; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jira_issues
    ADD CONSTRAINT fk_rails_97fc208031 FOREIGN KEY (product_id) REFERENCES public.products(id);
