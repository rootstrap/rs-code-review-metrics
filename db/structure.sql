...
--
-- Name: index_products_on_jira_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_products_on_jira_project_id ON public.products USING btree (jira_project_id);
...
--
-- Name: products fk_rails_f6e492a8da; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.products
    ADD CONSTRAINT fk_rails_f6e492a8da FOREIGN KEY (jira_project_id) REFERENCES public.jira_projects(id);
